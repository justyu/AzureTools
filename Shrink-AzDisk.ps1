# ref: https://jrudlin.github.io/2019-08-27-shrink-azure-vm-osdisk/ 
# https://github.com/jrudlin/Azure/blob/master/General/Shrink-AzDisk.ps1

# Variables
$DiskID = "/subscriptions/x/resourceGroups/y/providers/Microsoft.Compute/disks/OsDisk_bd3bf2ad68064ee8b6c9a3df1c15e20a"
$VMName = "MyVM"
$DiskSizeGB = 32
$AzSubscriptionName = "Visual Studio Enterprise"
...
Select-AzSubscription -SubscriptionName $AzSubscriptionName
